...
export default {
    ...
    blocks: [
        { h2: "Joining and leaving" },
        {
            p: "The server thread handles a player joining and leaving. It borrows the player's region for the duration of the operation, less than a millisecond. Other regions see nothing, no player feels a difference, even during a wave of a hundred connections."
        },
        { p: "Respawn goes from the player's region to the region of their respawn point, or to the server thread if no region covers that point." },
        { h2: "Packets" },
        {
