...
Minecraft est fait de chunks de 16x16 blocs. Une région est un groupe de chunks qui tick ensemble. Chaque chunk a un propriétaire, et c'est le seul qui a le droit d'y écrire.
...
:::note{tone="warn"}
Le troisième cas est mentionné dans les [Compromis](/docs/trade-offs). Il ne se produit que quand on écrit chez un autre joueur pendant qu'il y est.
:::