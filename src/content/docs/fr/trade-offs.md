...
Ces compromis sont un peu des fonctionnalités. Ils sont même bénéfiques pour le jeu : moins de triche, ou plus de possibilités de gameplay. On évite de les supprimer.

1. Chaque région a son propre aléatoire. Aucun effet visible en jeu.
2. Chaque région vit à son propre TPS. Un four peut être plus lent d'une région à l'autre.
3. Toutes les commandes s'exécutent sur le thread serveur, qui emprunte les régions qu'elles touchent.
