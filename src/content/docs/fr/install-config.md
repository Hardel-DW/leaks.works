...
| `debug.per_region_logs` | `false` | Chaque thread prend le nom de sa région, `R#id dimension`, pendant son tick. Chaque ligne de log dit alors quelle région l'a écrite. |
